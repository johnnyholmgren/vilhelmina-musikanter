        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            ...
            <div className="relative text-base mx-auto max-w-prose lg:max-w-none">
              <figure>
                <div className="relative pb-7/12 lg:pb-0">
                  <img
                    src="/foton/johnny_holmgren_foto_r_thellbro-500x505.jpg"
                    alt=""
                    width="500"
                    height="505"
          ...
          <div>
            ...
            <div className="prose text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
              <p>
                Jag har alltid älskat musik. Min morfar utrustade mig redan i 6 års ålder med ett
